...
const double _kTimePickerHeaderControlHeight = 70.0;
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  _TappableLabel _buildTappableLabel(TextTheme textTheme, Color color,
    ...
    final TextStyle style =
        textTheme.bodyText1!.copyWith(fontFamily: 'Montserrat', color: color);
  ...
  Widget build(BuildContext context) {
    ...
    final Color backgroundColor = Color(0xFF1B1C20);
    final Color accentColor = Color(0xFFFF4F01);
    final Color primaryLabelColor = Color(0xFFC0C1C2);
    final Color secondaryLabelColor = Color(0xFF1B1C20);
              ...
              children: <Widget>[
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                        fontFamily: 'Montserrat', color: Color(0xFFC0C1C2)),
                  ),
                ),
                TextButton(
                  onPressed: _handleOk,
