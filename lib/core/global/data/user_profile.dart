...
abstract class UserProfile {
  ...
  List<AddUnparkedEntity>? getUnparked();
  void setUnparked(List<AddUnparkedEntity> unParked);
}
...
class UserProfileImpl extends UserProfile {
  ...
  static List<AddUnparkedEntity>? _unParked;
  ...
  List<AddUnparkedEntity>? getUnparked() => _unParked;
  void setUnparked(List<AddUnparkedEntity> unParked) {
    _unParked = unParked;
  }
}
